...
Repository constraint: keep all temporary files, scratch projects, clones, and
CLI temporary output under `<repo-root>/.tmp/`. Set `TMPDIR` to that directory
when running CLI commands; never use system temporary directories.
