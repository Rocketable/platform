...
func TestAllowedWorkflowDescriptionsFiltersWorkflowAllow(t *testing.T) {
	...
	got := allowedWorkflowDescriptions(permissions, []workflow.Description{
		{Name: "audit-routes", Description: "Audit"},
		{Name: "secret-flow", Description: "Secret"},
		{Name: "other", Description: "Other"},
	})
	require.Equal(t, []workflow.Description{{Name: "audit-routes", Description: "Audit"}}, got)
}
...
func TestDynamicWorkflowToolSchemaAndCall(t *testing.T) {
	...
	tool, ok := dynamicWorkflowTool(permissions, []workflow.Description{
	...
	_, ok = dynamicWorkflowTool(rocketcode.PermissionSet{}, []workflow.Description{{Name: "audit", Description: "A"}}, nil)
	assert.False(t, ok)
}
