...
| Slack social mode  | Configured app mentions in allowed Slack channels can start channel-scoped conversations for configured agents. Replies in social-mode-gated Slack channel threads are normally consumed, but Slack-resolved pings to others are skipped unless the RocketClaw bot is also mentioned. Unconfigured channels are ignored.                                                                                           |
