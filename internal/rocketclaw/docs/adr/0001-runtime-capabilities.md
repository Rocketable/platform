...
| Slack goal loops   | Slack DM `🔁`/`🏁` prompts and Slack social-mode `@BotName 🔁`/`@BotName 🏁` mentions can start persisted managed-thread goal loops with optional `maxTurns:` budgets, as specified by ADR 0007.                    |
