...
export type Session = { id: string; title?: string; preview?: string; updatedAt?: string; agent?: string; settled?: boolean; allowedAgents?: string[]; running?: boolean; pinned?: boolean; name?: string; snoozedUntil?: string; forkedFrom?: string };
