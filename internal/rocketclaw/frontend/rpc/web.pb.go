...
func (x *HistoryResponse) GetTexts() []string {
	if x != nil {
		return x.Texts
	}
	return nil
...
func (x *SideAskRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SideAskRequest) ProtoMessage() {}

func (x *SideAskRequest) ProtoReflect() protoreflect.Message {
	mi := &file_web_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SideAskRequest.ProtoReflect.Descriptor instead.
func (*SideAskRequest) Descriptor() ([]byte, []int) {
	return file_web_proto_rawDescGZIP(), []int{22}
}

func (x *SideAskRequest) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *SideAskRequest) GetEntryId() int64 {
	if x != nil {
		return x.EntryId
	}
	return 0
...
func (x *SideAskRequest) GetQuestion() string {
	if x != nil {
		return x.Question
	}
	return ""
...
const file_web_proto_rawDesc = "" +
	...
	"\x13ListSessionsRequest\"\x98\x01\n" +
	"\aSession\x12\x0e\n" +
	...
	"\asettled\x18\x06 \x01(\bR\asettled\" \n" +
	"\x0eHistoryRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"'\n" +
	"\x0fHistoryResponse\x12\x14\n" +
	...
	"\bcomplete\x18\x04 \x01(\bR\bcomplete\"d\n" +
	...
	"\x0eSideAskRequest\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\x12\x19\n" +
	"\bentry_id\x18\x02 \x01(\x03R\aentryId\x12\x1a\n" +
	...
	"\x06agents\x18\x02 \x03(\tR\x06agents\"\x94\x03\n" +
	"\n" +
	"ConfigView\x12\x1c\n" +
	...
	"\fmcp_external\x18\t \x01(\bR\vmcpExternalJ\x04\b\n" +
	"\x10\vR\x0fmcp_development\"\x13\n" +
	...
	"\n" +
	"RunCronJob\x12\x16.rpc.RunCronJobRequest\x1a\x17.rpc.RunCronJobResponse\x126\n" +
	"\aSideAsk\x12\x13.rpc.SideAskRequest\x1a\x14.rpc.TranscriptEvent0\x01\x12I\n" +
...
var file_web_proto_goTypes = []any{
	...
	(*SideAskRequest)(nil),               // 23: rpc.SideAskRequest
	(*AnswerQuestionRequest)(nil),        // 24: rpc.AnswerQuestionRequest
	(*AnswerQuestionResponse)(nil),       // 25: rpc.AnswerQuestionResponse
	(*ConfigModel)(nil),                  // 26: rpc.ConfigModel
	(*ConfigChannel)(nil),                // 27: rpc.ConfigChannel
	(*ConfigView)(nil),                   // 28: rpc.ConfigView
	(*ListConfigRequest)(nil),            // 29: rpc.ListConfigRequest
	(*ListConfigResponse)(nil),           // 30: rpc.ListConfigResponse
	(*SettleSessionRequest)(nil),         // 31: rpc.SettleSessionRequest
	(*SettleSessionResponse)(nil),        // 32: rpc.SettleSessionResponse
	(*ProtocolRequest)(nil),              // 33: rpc.ProtocolRequest
	(*ProtocolResponse)(nil),             // 34: rpc.ProtocolResponse
	(*QueueItem)(nil),                    // 35: rpc.QueueItem
	(*ListQueueRequest)(nil),             // 36: rpc.ListQueueRequest
	(*ListQueueResponse)(nil),            // 37: rpc.ListQueueResponse
	(*QueueItemRequest)(nil),             // 38: rpc.QueueItemRequest
	(*QueueItemResponse)(nil),            // 39: rpc.QueueItemResponse
	(*ReorderQueueRequest)(nil),          // 40: rpc.ReorderQueueRequest
	(*SessionEntriesRequest)(nil),        // 41: rpc.SessionEntriesRequest
	(*SessionEntryMeta)(nil),             // 42: rpc.SessionEntryMeta
	(*ListSessionEntriesResponse)(nil),   // 43: rpc.ListSessionEntriesResponse
	(*SessionEntryData)(nil),             // 44: rpc.SessionEntryData
	(*LoadSessionEntriesResponse)(nil),   // 45: rpc.LoadSessionEntriesResponse
	(*DeleteSessionEntriesResponse)(nil), // 46: rpc.DeleteSessionEntriesResponse
}
var file_web_proto_depIdxs = []int32{
	2,  // 0: rpc.ListSessionsResponse.sessions:type_name -> rpc.Session
	0,  // 1: rpc.PromptRequest.delivery:type_name -> rpc.PromptDelivery
	13, // 2: rpc.ListAgentsResponse.agents:type_name -> rpc.Agent
	16, // 3: rpc.ListSkillsResponse.skills:type_name -> rpc.Skill
	12, // 4: rpc.ListCronJobsResponse.jobs:type_name -> rpc.CronJob
	26, // 5: rpc.ConfigView.models:type_name -> rpc.ConfigModel
	27, // 6: rpc.ConfigView.slack_channels:type_name -> rpc.ConfigChannel
	28, // 7: rpc.ListConfigResponse.config:type_name -> rpc.ConfigView
	35, // 8: rpc.ListQueueResponse.items:type_name -> rpc.QueueItem
	42, // 9: rpc.ListSessionEntriesResponse.entries:type_name -> rpc.SessionEntryMeta
	44, // 10: rpc.LoadSessionEntriesResponse.entries:type_name -> rpc.SessionEntryData
	1,  // 11: rpc.Web.ListSessions:input_type -> rpc.ListSessionsRequest
	6,  // 12: rpc.Web.CreateSession:input_type -> rpc.CreateSessionRequest
	8,  // 13: rpc.Web.Join:input_type -> rpc.JoinRequest
	10, // 14: rpc.Web.Prompt:input_type -> rpc.PromptRequest
	19, // 15: rpc.Web.ListCronJobs:input_type -> rpc.ListCronJobsRequest
	21, // 16: rpc.Web.RunCronJob:input_type -> rpc.RunCronJobRequest
	23, // 17: rpc.Web.SideAsk:input_type -> rpc.SideAskRequest
	24, // 18: rpc.Web.AnswerQuestion:input_type -> rpc.AnswerQuestionRequest
	...
	29, // 22: rpc.Web.ListConfig:input_type -> rpc.ListConfigRequest
	31, // 23: rpc.Web.SettleSession:input_type -> rpc.SettleSessionRequest
	33, // 24: rpc.Web.Protocol:input_type -> rpc.ProtocolRequest
	36, // 25: rpc.Web.ListQueue:input_type -> rpc.ListQueueRequest
	38, // 26: rpc.Web.RemoveQueueItem:input_type -> rpc.QueueItemRequest
	38, // 27: rpc.Web.SteerQueueItem:input_type -> rpc.QueueItemRequest
	40, // 28: rpc.Web.ReorderQueue:input_type -> rpc.ReorderQueueRequest
	41, // 29: rpc.Web.ListSessionEntries:input_type -> rpc.SessionEntriesRequest
	41, // 30: rpc.Web.LoadSessionEntries:input_type -> rpc.SessionEntriesRequest
	41, // 31: rpc.Web.DeleteSessionEntries:input_type -> rpc.SessionEntriesRequest
	...
	9,  // 38: rpc.Web.SideAsk:output_type -> rpc.TranscriptEvent
	25, // 39: rpc.Web.AnswerQuestion:output_type -> rpc.AnswerQuestionResponse
	...
	30, // 43: rpc.Web.ListConfig:output_type -> rpc.ListConfigResponse
	32, // 44: rpc.Web.SettleSession:output_type -> rpc.SettleSessionResponse
	34, // 45: rpc.Web.Protocol:output_type -> rpc.ProtocolResponse
	37, // 46: rpc.Web.ListQueue:output_type -> rpc.ListQueueResponse
	39, // 47: rpc.Web.RemoveQueueItem:output_type -> rpc.QueueItemResponse
	39, // 48: rpc.Web.SteerQueueItem:output_type -> rpc.QueueItemResponse
	39, // 49: rpc.Web.ReorderQueue:output_type -> rpc.QueueItemResponse
	43, // 50: rpc.Web.ListSessionEntries:output_type -> rpc.ListSessionEntriesResponse
	45, // 51: rpc.Web.LoadSessionEntries:output_type -> rpc.LoadSessionEntriesResponse
	46, // 52: rpc.Web.DeleteSessionEntries:output_type -> rpc.DeleteSessionEntriesResponse
